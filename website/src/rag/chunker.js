...
function normalizeSlug(filePath, docsRoot) {
...
function extractSections(raw, title) {
    const cleaned = removeFrontmatter(raw);
...
function splitTextIntoChunks(text, maxWords = 850, overlapWords = 160) {
...
function buildChunkId(slug, sectionHeading, index) {
...
export async function loadDocumentChunks(filePath, docsRoot) {
