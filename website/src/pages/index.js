...
function ModulesSection() {
    ...
    return (<section className="container margin-vert--lg">
      ...
      <div className="card-container">
        {modules.map((module, index) => (<ModuleCard key={index} title={module.title} description={module.description} to={module.to} icon={module.icon}/>))}
      </div>
    </section>);
}
function CTASection() {
    return (<section className="container margin-vert--lg">
      <div className="text--center padding-horiz--md">
        ...
        <div className={styles.buttons}>
          <Link className="button button--primary button--lg margin-right--md" to="/introduction">
            Begin Learning
          </Link>
          <Link className="button button--secondary button--lg" to="/humanoid-robotics-basics">
            Explore Content
          </Link>
        </div>
      </div>
...
export default function Home() {
    const { siteConfig } = useDocusaurusContext();
    return (<Layout title={`Home`} description="Physical AI & Humanoid Robotics Textbook - An AI-native textbook on Physical AI and Humanoid Robotics">
      <HomepageHeader />
      <main>
        <ModulesSection />
        <CTASection />
